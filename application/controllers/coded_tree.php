...
class coded_tree extends CI_Controller {

	function __construct()
 	{
   		parent::__construct(); 
		if(!$this->session->userdata('logged_ol_member')){header('Location: '.base_url().'index.php/login');exit;} 
		$this->load->model('coded_tree_model','',TRUE);
	...
	{
		$result=$this->coded_tree_model->get_all_referral($this->session->userdata['logged_ol_member']['usercode']);
	...
	function get_next_level(){
		...
		$result=$this->coded_tree_model->get_all_referral_next($usercode);
		$node_count=count($result);
