...
class martix_message extends CI_Controller {
	...
	function __construct()
 	{
		...
		$this->load->model('matrix_comman/martix_message_module','ObjM',TRUE);
	...
	public function inbox()
	{
		...
		$this->load->view(''.MATRIX_FOLDER.'/member/matrix_message_view',$data);
	...
	function compose(){
		...
		$this->load->view('comman/topheader');
		$this->load->view('comman/header');
		$this->load->view(''.MATRIX_FOLDER.'/member/matrix_message_send',$data);
		$this->load->view('comman/footer');	
