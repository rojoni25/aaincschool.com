...
class member extends CI_Controller {
	...
	function member_list(){
		...
		$data['contain']		=	$this->comman_fun->get_table_data('cms_pages_master',array('pagelable'=>'m2m_your_referral'));
		
		$this->load->view('comman/topheader');
		$this->load->view('comman/header');
		$this->load->view('m2m/member/member_list_view',$data);
	...
	function gift_earned(){
		...
		$data['contain']		=	$this->comman_fun->get_table_data('cms_pages_master',array('pagelable'=>'m2m_donation'));
		
		$this->load->view('comman/topheader');
		$this->load->view('comman/header');
		$this->load->view('m2m/member/gift_earned_view',$data);
		$this->load->view('comman/footer');			
	}
	...
	function gift_earned_detail($eid){
		...
		if(isset($data['result'][0])){
			...
			$this->load->view('comman/topheader');
			$this->load->view('comman/header');
			$this->load->view('m2m/member/gift_earned_detail',$data);
			$this->load->view('comman/footer');	
		}
	...
	function capture_page(){
			...
			$data['contain']		=	$this->comman_fun->get_table_data('cms_pages_master',array('pagelable'=>'m2m_capture_page'));
			//$data['result']	 =	$this->comman_fun->get_table_data('m2m_capture_page');	
			
			//---------------------dfsm--------------------------------
			$data['result']	 =	$this->comman_fun->get_table_data('m2m_capture_master');
			//---------------------dfsm--------------------------------	
			$this->load->view('comman/topheader');
			$this->load->view('comman/header');
			$this->load->view('m2m/member/capture_page',$data);
			$this->load->view('comman/footer');	
	}
