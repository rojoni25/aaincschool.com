...
class pdl_downline_tree extends CI_Controller {
	...
	function __construct()
 	{
		...
		$this->load->model('pdl/member/pdl_downline_tree_model','ObjM',TRUE);
	...
	public function view()
	{
		...
		$this->load->view('pdl_member/pdl_downline_tree_view',$data);
	...
	function get_member_detail($eid)
	{
		...
		<tr><td width="30%">Usercode</td><td width="70%">'.$result[0]['usercode'].'</td></tr>
		<tr><td >Name</td><td>'.$result[0]['fname'].' '.$result[0]['lname'].'</td></tr>
