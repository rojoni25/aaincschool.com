...
class rm_martix_message extends CI_Controller {
	...
	function __construct()
 	{
		...
		$this->load->model('rm_martix_message_module','ObjM',TRUE);
	...
	public function inbox()
	{
		...
		$this->load->view('r_matrix_member/rm_matrix_message_view',$data);
	...
	function compose(){
		...
		$this->load->view('comman/topheader');
		$this->load->view('comman/header');
		$this->load->view('r_matrix_member/rm_matrix_message_send',$data);
		$this->load->view('comman/footer');	
