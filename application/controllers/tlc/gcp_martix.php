...
class gcp_martix extends CI_Controller {
	...
	protected function r_joined_member_view(){
		...
		$data['cms']	=	$this->ObjM->get_cms_page(MATRIX_TABLE_PRE.'gcp_matrix');
		...
		$this->load->view('comman/topheader');
		$this->load->view('comman/header');
		$this->load->view(''.MATRIX_FOLDER.'/member/gcp_martix_home',$data);
		$this->load->view('comman/footer');
	}
