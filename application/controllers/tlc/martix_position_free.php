...
class martix_position_free extends CI_Controller {
	...
	function __construct()
 	{
		...
		$this->load->model('matrix_comman/martix_position_module_free','ObjM',TRUE);
	...
	public function view()
	{
		...
		$this->load->view(''.MATRIX_FOLDER.'/member/martix_position_view_free',$data);
	...
	function position_detail($eid)
	{
		...
		$this->load->view('comman/topheader');
		$this->load->view('comman/header');
		$this->load->view(''.MATRIX_FOLDER.'/member/martix_position_detail_free',$data);
		$this->load->view('comman/footer');	
	}
