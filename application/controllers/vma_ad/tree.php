...
class tree extends CI_Controller {
	...
	public function view($eid)
	{
		...
		$this->load->view('vma_ad/tree_view',$data);
	...
	function get_tree($code=''){
		...
		if(isset($result[0])){
			$name=$result[0]['name'];
			$tree_arr['level_one_img1']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$result[0]['usercode']."'><img src='".base_url()."/asset/images/multitree/green.png' title='".$name."' /></a>";
		...
		if(isset($result[1])){
			$name=$result[1]['name'];
			$tree_arr['level_one_img2']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$result[1]['usercode']."'><img src='".base_url()."/asset/images/multitree/red.png' title='".$name."' /></a>";
		...
		if(isset($result[2])){
			$name=$result[2]['name'];
			$tree_arr['level_one_img3']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$result[2]['usercode']."'><img src='".base_url()."/asset/images/multitree/blue.png' title='".$name."' /></a>";
		...
		if(isset($room[0][0])){
			$name=$room[0][0]['name'];
			$tree_arr['level_two_img1']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[0][0]['usercode']."'><img src='".base_url()."/asset/images/multitree/green.png' title='".$name."' /></a>";
		...
		if(isset($room[0][1])){
			$name=$room[0][1]['name'];
			$tree_arr['level_two_img2']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[0][1]['usercode']."'><img src='".base_url()."/asset/images/multitree/red.png' title='".$name."' /></a>";
		...
		if(isset($room[0][2])){
			$name=$room[0][2]['name'];
			$tree_arr['level_two_img3']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[0][2]['usercode']."'><img src='".base_url()."/asset/images/multitree/blue.png' title='".$name."' /></a>";
		...
		if(isset($room[1][0])){
			$name=$room[1][0]['name'];
			$tree_arr['level_two_img4']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[1][0]['usercode']."'><img src='".base_url()."/asset/images/multitree/green.png' title='".$name."' /></a>";
		...
		if(isset($room[1][1])){
			$name=$room[1][1]['name'];
			$tree_arr['level_two_img5']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[1][1]['usercode']."'><img src='".base_url()."/asset/images/multitree/red.png' title='".$name."' /></a>";
		...
		if(isset($room[1][2])){
			$name=$room[1][2]['name'];
			$tree_arr['level_two_img6']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[1][2]['usercode']."'><img src='".base_url()."/asset/images/multitree/blue.png' title='".$name."' /></a>";
		...
		if(isset($room[2][0])){
			$name=$room[2][0]['name'];
			$tree_arr['level_two_img7']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[2][0]['usercode']."'><img src='".base_url()."/asset/images/multitree/green.png' title='".$name."' /></a>";
		...
		if(isset($room[2][1])){
			$name=$room[2][1]['name'];
			$tree_arr['level_two_img8']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[2][1]['usercode']."'><img src='".base_url()."/asset/images/multitree/red.png' title='".$name."' /></a>";
		...
		if(isset($room[2][2])){
			$name=$room[2][2]['name'];
			$tree_arr['level_two_img9']="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$room[2][2]['usercode']."'><img src='".base_url()."/asset/images/multitree/blue.png' title='".$name."' /></a>";
		...
		for($i=0;$i<count($lev3);$i++){
			...
			if(isset($rg[0])){
				...
				$tree_arr['lev3img'.$p]="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$rg[0]['usercode']."'><img src='".base_url()."asset/images/multitree/green.png' title='' /></a>";		
			}
			else{
				$tree_arr['lev3nm'.$p]="";
			...
			if(isset($rg[1])){
				...
				$tree_arr['lev3img'.$p]="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$rg[1]['usercode']."'><img src='".base_url()."asset/images/multitree/red.png' title='' /></a>";		
			}
			else{
				$tree_arr['lev3nm'.$p]="";
				$tree_arr['lev3img'.$p]="<img src='".base_url()."asset/images/multitree/empty.png' title='' />";		
			...
			if(isset($rg[2])){
				...
				$tree_arr['lev3img'.$p]="<a  href='".vma_ad().$this->uri->rsegment(1)."/view/".$rg[2]['usercode']."'><img src='".base_url()."asset/images/multitree/blue.png' title='' /></a>";		
			}
			else{
				$tree_arr['lev3nm'.$p]="";
				$tree_arr['lev3img'.$p]="<img src='".base_url()."asset/images/multitree/empty.png' title='' />";		
