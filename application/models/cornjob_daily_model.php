 ...
 function get_setting_value_by_lable($value){
	...
	function row_delete()
  {
  	...
  	function get_reverse_remain_wallet($uid,$type)
	{
		...
		$query = $this -> db -> get();
    	$the_content = $query->result_array();
    	return $the_content[0]['remain_'.$type];
	}
	...
	function get_reverse_upling_chain_free($eid, $field)
	{
		...
		$arr=array();
		$arr['lev1']=($the_content[0]['lev1']=='0' || $the_content[0]['lev1']=='')? "2" : $the_content[0]['lev1'];
		$arr['lev2']=($the_content[0]['lev2']=='0' || $the_content[0]['lev2']=='')? "2" : $the_content[0]['lev2'];
		$arr['lev3']=($the_content[0]['lev3']=='0' || $the_content[0]['lev3']=='')? "2" : $the_content[0]['lev3'];	
    	return $arr;
