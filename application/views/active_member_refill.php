<?php
	...
	$amount 		= $_POST['refill_amount'];
	$decription 	= "ONE TIME PAYMENT";
	...
	$wallet=($_POST['account_type']=='personal_wallet') ? "PW" : "CW";

	$sequence	= rand(1, 1000);
	
	$invoice	= '102_'.$wallet.'_'.$this->session->userdata['logged_ol_member']['usercode'].'_'.$sequence;
...
<body>
    ...
    <input type="HIDDEN" name="x_first_name" value="<?=$this->session->userdata['logged_ol_member']['fullname']?>">
