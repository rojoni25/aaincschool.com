...
<div class="row-fluid ">
  <div class="span12">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="#">Affiliate Payment</a><span class="divider"><i class="icon-angle-right"></i></span></li>
  ...
  <div class="row-fluid">
    <div class="span12">
      <table width="100%">
        ...
        <tr>
          <td><textarea id="msg" name="msg" placeholder="Enter Confirmation Message to Affiliate member" class="txtarea" value="" required="required"></textarea></td>
        </tr>
        <tr>
