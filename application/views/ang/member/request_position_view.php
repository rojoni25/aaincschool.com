...
<div class="row-fluid">
  <div class="span12">
    <h3 class="page-header">Request Position 
    	...
    	<a href="<?=MATRIX_BASE?><?=$this->uri->rsegment(1)?>/extra_position_popup" class="pull-right show-pop-event"><span class="label label-success"><font style="font-weight:bold;letter-spacing:1px;font-size:16px;">Request Send For Extra Position</font></span></a>
