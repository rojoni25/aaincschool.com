...
-->
        <form method="post" action="<?=base_url()?>index.php/authorize_api/subscription_create">
        ...
        <form method="post" action="subscription_update.php">
            <table width="29%" border="0">
                <tr>
                    <td>
                        <b><font size="2" face="arial">Update Subscription</font><br>
                        <br></b>
                    </td>
                    <td></td>
                </tr>
                <tr>
                    <td>
                        <font size="2" face="arial">Subscription Id</font>
                    </td>
                    <td>
                        <input type="text" name="subscriptionId" value=''>
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <form method="post" action="subscription_cancel.php">
            <table width="29%" border="0">
                <tr>
                    <td>
                        <b><font size="2" face="arial">Cancel Subscription</font><br>
                        <br></b>
                    </td>
                    <td></td>
                </tr>
