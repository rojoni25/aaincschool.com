...
<div class="tz-2 tz-2-admin">
		...
		<h4>
			Upgrade
		      ...
		      ?>
		        <span class="" style="color: #fff;padding-left: 10px;">
		          <i style="color: yellow;font-size: 20px;" class="fa fa-money" aria-hidden="true"></i> 
		          <span style="color: darkgoldenrod;font-size: 20px;">  Refferal Wallet : </span>
	...
	<div class="tz-2-com tz-2-main">
		<div class="row">
		    ...
		    <div style="clear:both;overflow:hidden;"></div>
	      	   ...
	      	   <div class="payment-form-container col-md-6 ">
    ...
    <div class="form-container">
        ...
        <div class="field-container">
            ...
            <input id="amount" name="amount" value="12" type="hidden">
        </div>
        <div class="field-container">
        ...
        <div class="field-container">
        <button id="payment-confirm-subscription">Pay Now ($12)</button>
        </div>
