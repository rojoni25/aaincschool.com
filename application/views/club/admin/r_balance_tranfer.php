...
<div class="row-fluid ">
  <div class="span6">
    <?php if($payment['balance']){?>
    <form action="<?=MATRIX_BASE?><?=$this->uri->rsegment(1)?>/tranfer_amount" method="post" id="ftranfer">
      ...
      <table class="table table-striped table-bordered dataTable" id="data-table">
        <tr>
          ...
          <td>:</td>
          <td><input type="number" required name="amount" id="amount" placeholder="Enter Tranfer Amount" /></td>
        </tr>
