  ...
  <div class="span12">
    <div class="switch-board gray"> 
      <ul class="clearfix switch-item switch_item_custom">
         ...
         <li><a href="<?=MATRIX_BASE?>company_pages/view/criptos" class="cls-color-3"><i class="icon-book"></i><span>Criptos</span></a></li>
         <li><a href="<?=MATRIX_BASE?>company_pages/view/adsacty" class="cls-color-6"><i class="icon-book"></i><span>Adsacty</span></a></li>
      </ul>
    </div>
  </div>
</div>
