  ...
  <div class="span12">
    ...
    <div class="span4">
    	  <div style="text-align:center;">
	    	  ...
	    	  <a class="payment_btn temp-hide" href="<?=base_url()?>index.php/monthly_payment_active_member/clubpay"><img src="<?=base_url()?>asset/images/credit_card_img.gif" alt="Payment" /></a> 
    	</div>
    </div>
    <?php } ?>
    ...
    <?php if(!$check['in_tree']){?>
     <div class="span4">
      <form action="<?=MATRIX_BASE?><?=$this->uri->rsegment(1)?>/view" method="post" id="frmsubmit2" style="margin:0px;">
        <label style="margin-top:9px;float:left;margin-right:5px;"><strong>Enter
          <?=MATRIX_CODE_LLB?>
          Code</strong></label>
