  ...
  <div class="left-nav clearfix">
    <div class="left-primary-nav">
      <ul id="myTab">
		...
		<!------------------------------smfund--------------------------------------------------->
		<?php if(($smfund_admin_valid)||($this->session->userdata['logged_smfund_member'])){?>
        <!------------------------------smfund--------------------------------------------------->
        ...
        <li class="<?=$main_m2m_admin?>"><a href="#m2m_admin" class="fa fa-graduation-cap" title="DFSM Admin"></a></li>
        <?php } ?>
        <?php if($this->comman_fun->check_record('m2m_member',array('usercode'=>$this->session->userdata['logged_ol_member']['usercode']))){ ?>
        <li class="<?=$main_m2m_member?>"><a href="#m2m_member" class="fa fa-graduation-cap" title="DFSM Member"></a></li>
        <?php } ?>
        <!----DFSM(It's your dream now)-->
...
<?php */?>         <!------TLC-------------->
      ...
      <div class="tab-pane <?=$main_m2m_admin?>" id="m2m_admin">
        ...
        <!-------------D-ADM--------------------------->
         <?php if($this->comman_fun->check_record('dadm_matrix_admin',array('usercode'=>$this->session->userdata['logged_ol_member']['usercode']))){ ?>
          <h4 class="side-head">D-ADM Admin</h4>		   
          <li class=""><a href="<?=base_url();?>index.php/d-adm/r_matrix/dashboard"><i class="icon-dashboard"></i>Dashboard</a></li>
          <?php }?>
        <!-------------D-ADM--------------------------->		   
