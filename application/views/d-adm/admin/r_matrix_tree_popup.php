...
<script>
	...
	$(document).on('click', '.set_member', function (e) {
		e.preventDefault();
		var value 		= $(this).attr('href');	
		var url='<?php echo MATRIX_BASE;?>r_matrix_tree/get_upling_path_for_pop_up/'+value;
	...
	$(document).on('click','.btnsearch', function (e) {
		...
		var url='<?php echo MATRIX_BASE;?>r_matrix_tree/find_member/'+$('#meberserch').val();
		$.ajax({url:url,success:function(result){	
		...
		function bind_tree(value){
			...
			var url='<?php echo MATRIX_BASE;?>r_matrix_tree/tree_drow/'+value;
			$.ajax({url:url,success:function(result){	
				var data=$.parseJSON(result)
