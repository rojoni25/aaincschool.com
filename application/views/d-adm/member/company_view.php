...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header"><?=MATRIX_LLB?> Company </h3>
    </div>
    <ul class="breadcrumb">
	...
	<table class="table table-striped table-bordered dataTable" id="data-table">
            ...
            <tbody>
            	<?php for($i=0;$i<count($result);$i++){
                    ...
                    <th><a href="<?=MATRIX_BASE?><?=$this->uri->rsegment(1)?>/detail/<?=$result[$i]['company_code']?>"><span class="label label-success">View Company</span></a></th>
