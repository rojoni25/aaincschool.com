  ...
  <div class="span12">
    <div class="primary-head">
    	 <div style="width:88%;display: inline-block;">	
          ...
          <p style="text-align:right;"></i><a class="btn btn btn-primary" href="<?=base_url();?>/index.php/m2m/page/view"><i class="fa fa-arrow-left"> Back</i></a></p>
          </div>
  ...
  <div class="span12">
    <div class="switch-board gray"> 
      <ul class="clearfix switch-item switch_item_custom">
         ...
         <li><a href="<?=MATRIX_BASE?>company_pages/view/" class="cls-color-3"><i class="icon-book"></i><span>Company Pages</span></a></li>
          <li><a href="<?=MATRIX_BASE?>contain/view/webinar" class="cls-color-1"><i class="icon-book"></i><span>Webinar</span></a></li>
         <li><a href="<?=MATRIX_BASE?>contain/view/training" class="cls-color-5"><i class="icon-book"></i><span>Training</span></a></li>
      </ul>
    </div>
  </div>
</div>
