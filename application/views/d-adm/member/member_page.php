  ...
  <div class="span12">
    ...
    <div class="span4">
    	  <div style="text-align:center;">
	    	  ...
	    	  <a class="payment_btn temp-hide" href="<?=base_url()?>index.php/monthly_payment_active_member/ltpay"><img src="<?=base_url()?>asset/images/credit_card_img.gif" alt="Payment" /></a> 
    	</div>
    </div>
    <?php } ?>
