...
<div class="row-fluid ">
  <div class="span12">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="#">D2V CMS</a><span class="divider"><i class="icon-angle-right"></i></span></li>
...
<div class="row-fluid">
  <div class="span12">
    <form class="form-horizontal left-align" id="form2" method="post" action="<?php echo base_url();?>index.php/d2v/<?=$this->uri->rsegment(1)?>/insertrecord" enctype="multipart/form-data">
      ...
      <div class="form-actions">
        ...
        <a href="<?php echo base_url();?>index.php/d2v/<?=$this->uri->rsegment(1)?>">
