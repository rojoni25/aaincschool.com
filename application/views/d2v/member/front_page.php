    ...
    <div class="primary-head">
      <h3 class="page-header">
        ...
        <span class="pull-right">
        	<a class="show-pop-event cls_head_btn" href="<?=base_url()?>index.php/d2v/<?=$this->uri->rsegment(1)?>/send_request/" class="btn-right"><span class="label label-important">Send Payment</span></a>&nbsp;&nbsp;
            <a class="cls_head_btn" href="<?=base_url()?>index.php/d2v/<?=$this->uri->rsegment(1)?>/msg_to_admin/" class="btn-right"><span class="label label-success">Send Payment</span></a>
        </span> 
     </h3>
    </div>
  </div>
