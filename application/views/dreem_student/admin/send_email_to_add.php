...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">Dreem Student Email (All) <span class="pull-right"><a href="<?=base_url()?>index.php/dreem_student/ad_dashboard/">
...
<div class="row-fluid">
  <div class="span6">
    <form class="form-horizontal left-align" id="form2" method="post" action="<?php echo base_url();?>index.php/dreem_student/<?=$this->uri->rsegment(1)?>/send_to_all" enctype="multipart/form-data">
  ...
  <div class="span6">
  		<table class="table table-striped table-bordered">
        	<tr>
            	<td>Send email to all member</td>
            </tr>
