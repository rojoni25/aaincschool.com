...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">Capture Page (Dreem Student)
                ...
                <tbody>
                	<?php for($i=0;$i<count($result);$i++){ 
                    	...
                    	echo '<tr>
                            	...
                            	<td>'.base_url().'index.php/capture/dreem_student/'.$result[$i]['id'].'/'.$this->session->userdata['logged_ol_member']['username'].'</td>
								<td><a target="_blank" href="'.base_url().'index.php/capture/dreem_student/'.$result[$i]['id'].'/'.$this->session->userdata['logged_ol_member']['username'].'">Priview</a></td>
                        	</tr>';
                     } ?>
               </tbody> 
               </table>    
