      ...
      <h3 class="page-header">Payment Send To Member</h3>
      	...
      	<table class="table table-striped table-bordered">
            ...
            <tr>
            	<td>Email</td>
                <td>:</td>
                <td><a href="<?php echo base_url();?>index.php/dreem_student/<?=$this->uri->rsegment(1)?>/send_email">Send Email</a></td>
            </tr>
        </table>
    </div>
  </div>
...
<div class="row-fluid">
      <div class="span6">
      	<h3 class="page-header">Send Payment Confirmmation (Dreem Student)</h3>
        <form class="form-horizontal left-align" id="form2" method="post" action="<?php echo base_url();?>index.php/dreem_student/<?=$this->uri->rsegment(1)?>/payment_insert" enctype="multipart/form-data">
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <a href="<?=base_url()?>index.php/dreem_student/payment_option"><button class="btn btn-success"><strong>Set Your Payment Receiving</strong></button></a>
      </div>
    </div> 
