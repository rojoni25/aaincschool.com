...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">Payment Receiving Option
...
<div class="row-fluid">
  <div class="span12">
    	<form action="<?=base_url()?>index.php/dreem_student/<?=$this->uri->rsegment(1)?>/insertrecord/" method="post">
    	...
    	<tbody>
			...
			?>
            	<tr>
                    ...
                    <td><a href="<?=base_url()?>index.php/dreem_student/<?=$this->uri->rsegment(1)?>/delete/<?=$result[$i]['id']?>">Delete</a></td>
            	</tr>
            <?php } ?>
        </tbody>
