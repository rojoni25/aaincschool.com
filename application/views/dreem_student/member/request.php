      ...
      <div class="span12">
        <div class="primary-head">
          <h3 class="page-header"><?=$contain[0]['title']?> 
          	 <span class="pull-right"><a class="show-pop-event cls_head_btn" href="<?=base_url()?>index.php/dreem_student/<?=$this->uri->rsegment(1)?>/send_request/" class="btn-right"><span class="label label-important">Send Join Request</span></a></span>
          </h3>
        </div>
      </div>
    </div>
