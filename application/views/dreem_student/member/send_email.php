...
<div class="row-fluid">
      <div class="span12">
      	<h3 class="page-header">Send Email (Dreem Student)
        ...
        <form class="form-horizontal left-align" id="form2" method="post" action="<?php echo base_url();?>index.php/dreem_student/<?=$this->uri->rsegment(1)?>/send_email_insert" enctype="multipart/form-data">
