  ...
  <div class="span12">
    <form class="form-horizontal left-align" id="form2" method="post" action="<?=MATRIX_BASE?><?=$this->uri->rsegment(1)?>/insert" enctype="multipart/form-data">
      ...
      <div class="control-group">
        <label class="control-label">Benefits Pages Name <span class="req">*</span></label>
        <div class="controls">
          <input id="company_name" name="company_name" value="<?=$result[0]['company_name']?>" type="text" required="required" class="span12 {validate:{required:true}}" placeholder="Benefits Pages Name"/>
        </div>
      </div>
