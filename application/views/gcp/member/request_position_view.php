  ...
  <div class="span12">
    <h3 class="page-header">Request Position 
        ...
        <div class="pull-right">
        	<a href="<?=base_url()?>index.php/monthly_payment_active_member/gcppay" class="temp-hide"> <button class="btn btn-success btncustom" type="button">Online Payment</button> </a>
