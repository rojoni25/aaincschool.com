  ...
  <div class="span12">
    <div class="switch-board gray">
      <ul class="clearfix switch-item switch_item_custom">
        <li><a href="<?=MATRIX_BASE?>m_message/compose" class="dark-yellow"><i class="icon-share-alt"></i><span>Message To Admin</span></a></li>
        <li><a href="<?=MATRIX_BASE?>product/view/" class=" blue-violate"><i class="icon-lightbulb"></i><span>Product</span></a></li>
        <li><a href="#" class="cls-color-6"><p>$<?=number_format($account['balance'],2)?></p><span>Wallet</span></a></li>
...
<div class="row-fluid">
  <div class="span12">
    <div class="switch-board gray">
      <ul class="clearfix switch-item switch_item_custom">
        <li><a href="<?=MATRIX_BASE?>account/position" class="cls-color-1"><p><?=$count_position?></p><span>Position</span></a></li>
         <li><a href="<?=MATRIX_BASE?>account/withdrawal" class="cls-color-4"><i class="icon-money"></i><span>Withdrawal Request</span></a></li>
      </ul>
    </div>
  </div>
</div>
