                    	...
                    	echo '<tr>
								...
								<td>
										<div class="btn-group">
											...
											<li><a href="'.base_url().'index.php/capture/m2m_new/'.$result[$i]['page_code'].'/'.$this->session->userdata['logged_ol_member']['username'].'" class="pageperview" value="267">Preview</a></li>
