                ...
                <tbody>
                	<?php for($i=0;$i<count($result);$i++){ 
                    	...
                    	echo '<tr>
                            	...
                            	<td>'.base_url().'index.php/capture/m2m/'.$result[$i]['id'].'/'.$this->session->userdata['logged_ol_member']['username'].'</td>
								<td><a target="_blank" href="'.base_url().'index.php/capture/m2m/'.$result[$i]['id'].'/'.$this->session->userdata['logged_ol_member']['username'].'">Priview</a></td>
