<script>
		$(document).on('click', '.coded_li_click1', function (e) {
			...
			var url='<?=base_url();?>index.php/m2m/<?=$this->uri->rsegment(1)?>/get_next_level/'+usercode+'/'+level+'/'+posi+'/'+main_margin+'';	
...
<div class="row-fluid ">
      <div class="span12">
        <div class="primary-head">
          <h3 class="page-header">Your Friend (DFSM)
        ...
        <ul class="breadcrumb">
          ...
          <li class="active">Your Friend (DFSM)</li>
        </ul>
      </div>
    </div>
