...
<?php 
	function get_pay_btn1(){
		...
		$url=''.base_url().'index.php/monthly_payment_active_member/ams_pay/1';
		
		$html='
    		<div class="board-widgets bondi-blue temp-hide">
			<a href="'.$url.'">
	...
	function get_pay_btn2(){
		...
		$url=''.base_url().'index.php/monthly_payment_active_member/ams_pay/2';
