...
<?php } ?>
      ...
      <div class="span12">
        <div class="primary-head">
          <h3 class="page-header">Stripe Payment</h3>
        </div>
        <ul class="breadcrumb">
  ...
  <table>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <form class="form-horizontal left-align" id="paymentFrm" action="<?php echo base_url();?>index.php/online_payment_stripe/insertrecord" method="post">

            <div class="control-group">
            <label class="control-label">Card Holder Name</label>
            <div class="controls">
              <input type="text" class="span6" name="name" id="name" class="name"  />
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="span6" name="address" id="address" class="address"  />
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="span6" name="country" id="country" class="country" />
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="card_num" id="card_num" size="20" autocomplete="off" class="card-number span6" />
            </div>
          </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" placeholder="CVC" name="card_cvc" id="card_cvc" size="4" autocomplete="off" class="card-cvc span6" />
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="card_exp_month" id="exp_month" placeholder="MM" maxlength="2" class="card-expiry-month span6"/>

                <input type="text" name="card_exp_year" id="exp_year" maxlength="4" placeholder="YYYY" class="card-expiry-year span6"/>
