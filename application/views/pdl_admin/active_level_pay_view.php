...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">Active Level Pay</h3>
    </div>
    <ul class="breadcrumb">
      ...
      <li class="active">Active Level Pay</li>
    </ul>
  </div>
</div>
<div class="row-fluid">
    ...
    <table class="table table-striped table-bordered" id="data-table">
      <thead>
        <tr>
          ...
          <th width="10%">Name</th>
          <th width="10%">Level-1 (A/D)</th>
          <th width="10%">Level-2 (A/D)</th>
          <th width="10%">Level-3 (A/D)</th>
        </tr>
      </thead>
      <tbody>
      </tbody>
