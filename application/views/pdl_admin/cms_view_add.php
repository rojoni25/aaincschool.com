...
<div class="row-fluid">
  <div class="span12">
    <form class="form-horizontal left-align" id="form2" method="post" action="<?php echo base_url();?>index.php/pdl/<?=$this->uri->rsegment(1)?>/insertrecord" enctype="multipart/form-data">
