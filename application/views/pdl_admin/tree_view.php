	...
	$(document).ready(function(e) {
		...
		$(document).on('click', '.btngoto', function (e) {
			...
			if(value==''){
				...
				window.location.href='<?php echo pdl_admin_url()?><?php echo $this->uri->rsegment(1)?>/view/'+value;
			}
		});
...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">PDL Member Tree</h3>
    ...
    <ul class="breadcrumb">
    	<?php
			$urltree=base_url('index.php/pdl/').''.$this->uri->rsegment(1).'/tree/';
 ...
 <div class="top" style="text-align:center;">
    ...
    <p><a class='show-pop-event' href='<?php echo $this->uri->rsegment(3)?>'><?=$tree['top_nm']?></a></p>
 </div>
	...
	$(document).ready(function(e) {
		...
		$('.show-pop-event').each(function(i,elem) {
						...
						$(this).webuiPopover({
							...
							type:'async',
							container: "body",
							url:'<?php echo base_url('index.php/pdl/')?><?=$this->uri->rsegment(1)?>/get_member_detail/'+value,
							cache:false,
