...
<script>
	...
	function listing(){
		...
		var url='<?=base_url()?>index.php/pdl/<?=$this->uri->rsegment(1)?>/listing/';
	...
	function get_popover(){
		...
		$('.show-pop-event').each(function(i,elem) {
						...
						$(this).webuiPopover({
							...
							type:'async',
							container: "body",
							url:'<?php echo base_url()?>index.php/pdl/<?=$this->uri->rsegment(1)?>/popover_form/'+value+'',
							cache:false,
