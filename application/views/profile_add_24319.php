        ...
        ?>
         <div class="row">
            <ul class="tabs pg-ele-tab">
              <li class="tab col s2 active"><a data-toggle="tab" href="#personal-info">Personal Info</a></li>
              <li class="tab col s2"><a data-toggle="tab" href="#address">Address</a></li>
              <li class="tab col s2"><a data-toggle="tab" href="#contact-info">Contact Info</a></li>
              <li class="tab col s2"><a data-toggle="tab" href="#accounts-details">Accounts Details</a></li>
              <li class="tab col s2"><a data-toggle="tab" href="#other-details">Social</a></li>
              <li class="tab col s2"><a data-toggle="tab" href="#payment-details">Payment Details</a></li>
            </ul>
