...
<div class="container">
  <div class="content_fullwidth">
    ...
    <?php
	   ...
	   if($after_reg[0]['after_rg_link']!=''){
			echo '<div class="video_frm">';
			echo '<div class="inner_frm">';
			if (strpos($after_reg[0]['after_rg_link'], 'youtube') !== false)
			{
				echo '<iframe width="100%" height="100%" src="'.$after_reg[0]['after_rg_link'].'" frameborder="0" allowfullscreen></iframe>';
			}
			else{
				echo '<video width="100%" height="100%" controls="controls"><source src="'.$after_reg[0]['after_rg_link'].'" type="video/mp4"></video>';
			}
			echo '</div>';
			echo '</div>';
		}
	...
	?>
        ...
        <div class="one_full">
        	<?=$after_reg[0]['after_rg_text']!=''?$after_reg[0]['after_rg_text'].'<br><br>':''?>
        	<?=$result[0]['textdt']?>
        </div>
