  ...
  <?php
    ...
    if($result[0]['video_url1']!=''){
      ...
      if ($autoplay_state=='0' && strpos($result[0]['video_url1'], 'youtube') !== false){
        echo '<iframe style="width:809px; height:490px;" src="'.convertYoutube($result[0]['video_url1'], false, $autoplay_state).'" frameborder="0" allowfullscreen></iframe>';
      }
    ...
    echo '<video style="width:809px; height:490px;" controls="controls"><source src="'.$result[0]['video_url1'].'" type="video/mp4"></video>';
    if($autoplay_state=='1'){ ?>
      <script>
