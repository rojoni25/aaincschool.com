...
<head>
  ...
  <style type="text/css">
    body{
        ...
        font-size: 14px;
        color: #454444;
        background:  url('<?php echo base_url();?>asset/capturepages/page5.jpg') no-repeat center center fixed;
      }
      .page .myForm h1{
          color: #fff;
      ...
      <form  method="post" action="<?php echo base_url();?>index.php/rg/insertrecord" class="myForm">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
          ...
          <div class="embed-responsive embed-responsive-16by9 video <?php echo $mobile_frm;?>">
            <a class="thumbnail"><img src="<?php echo base_url();?>asset/capturepages/<?php echo $mobile_frm;?>.png"/></a>
