    ...
    <div class="mainform">
     <form class="form-signin" method="post" action="<?php echo base_url();?>index.php/rg/insertrecord">
      ...
      <table width="100%" cellspacing="5" cellpadding="2">
        <tr>
          <td width="30%" align="right"><font style="color:#415F07;font-weight:bold;">Your Inviter</font></td>
          <td width="2%"></td>
          <td width="68%"><font style="color:#415F07;font-weight:bold;"><?=$ref[0]['fname']?> <?=$ref[0]['lname']?></font></strong></td>
        </tr>
        <tr>
