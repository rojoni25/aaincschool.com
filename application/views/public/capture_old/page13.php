 ...
 $autoplay_state = $result[0]['page_bg_video_autoplay'];
		...
		if($result[0]['video_url1']!=''){
			...
			if (strpos($result[0]['video_url1'], 'youtube') !== false){
				...
				echo '<video style="width:100%; height:100vh;" controls autoplay><source src="'.$result[0]['video_url1'].'" type="video/mp4"></video>';
			}
	   }
...
<div class="container">
  ...
  <div class="formmain">
    ...
    <form class="form-signin" method="post" action="<?php echo base_url();?>index.php/rg/insertrecord">
      ...
      <p class="llbinviter">Your Inviter:<label>&nbsp;<?=$ref[0]['fname']?> <?=$ref[0]['lname']?>
        </label>
      </p>
      <p>
