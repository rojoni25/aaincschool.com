...
if($result[0]['video_url1']!=''){
			...
			if (strpos($result[0]['video_url1'], 'youtube') !== false){
				echo '<iframe style="width:100%; height:100vh;" src="'.convertYoutube($result[0]['video_url1'], N, $autoplay_state).'" frameborder="0" allowfullscreen></iframe>';
			}
			else{
				echo '<video style="width:100%; height:100vh;" controls="controls"><source src="'.$result[0]['video_url1'].'" type="video/mp4"></video>';
			}
	   }
