...
$autoplay_state = $result[0]['page_bg_video_autoplay'];
	if($result[0]['page_bg_img']==''){
		$page_bg_img=''.base_url().'asset/capturepages/page7.jpg';
	}
	else{
...
$(document).ready(function(){
   $mute_satatus = <?php echo $result[0]['page_bg_video_mute'] == 'Y' ? 'ture' : 'false' ?>;
   var audio = new Audio(('<?php echo $audio; ?>'),false,<?php echo $mute_satatus; ?>);
	audio.play();
});
</script>
<script>
