...
<h2 id="h2_head">KDK Code<a class="popup-modal-dismiss fromclose" href="#" title="Close"><i class="icon-remove"></i></a></h2>
<form action="<?=base_url()?>index.php/r_matrix_kdk_request/kdk_code_insert" method="post" id="frm_sub">
    ...
    <table class="table">
        ...
        <tr>
            <td>Enter KDK</td>
            <td>:</td>
            <td><input type="text" name="kdk_code" id="kdk_code" placeholder="kdk code" /></td>
        </tr>
        <tr class="submit_tr">
            <td></td>
            <td></td>
