    ...
    <form class="form-horizontal left-align" id="form2" method="post" action="<?php echo base_url();?>index.php/<?=$this->uri->segment(1)?>/kdk_code" enctype="multipart/form-data">
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td width="1%"></td>
          <td width="69%"><?=$result['dt']['usercode']?></td>
        </tr>
        <tr>
          <td>Username</td>
          <td></td>
      ...
      <div class="form-actions">
        <?php if($result['vali']){?>
        <a href="<?=base_url()?>index.php/<?=$this->uri->segment(1)?>/kdk_code">
        <button type="button" class="btn btn-primary"><strong>Search Member</strong></button>
        </a>&nbsp;&nbsp;&nbsp;&nbsp;
