...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">R-Matrix Extra Position Request</h3>
    </div>
    <ul class="breadcrumb">
    
      <li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
      <li><a href="#">R-Matrix</a><span class="divider"><i class="icon-angle-right"></i></span></li>
      <li class="active">Extra Position Request</li>
            ...
            <tbody>
            	<?php for($i=0;$i<count($result_list);$i++){?>
                    ...
                    <td>
                        ...
                        <a class="notification_link" href="<?=base_url()?>index.php/r_matrix_notification/popup/<?=$result_list[$i]['usercode']?>"><i class="icon-bell-alt"></i></a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>	
