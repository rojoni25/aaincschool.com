...
<script>
	$(document).on('submit','#frm_msg',function(e){
		e.preventDefault();
  ...
  <div class="span12">
    <div class="switch-board gray">
      <ul class="clearfix switch-item switch_item_custom">
        <li><a href="<?=base_url()?>index.php/rm_martix_position/view/" class="orange"><i class="icon-file-alt"></i><span>Position</span></a></li>
        <li><a href="<?=base_url()?>index.php/rm_martix_position/view/" class=" blue-violate"><i class="icon-lightbulb"></i><span>Position Details</span></a></li>
        <li><a href="<?=base_url()?>index.php/rm_martix_message/compose" class="dark-yellow"><i class="icon-share-alt"></i><span>Message To Admin</span></a></li>
        <li><a href="<?=base_url()?>index.php/rm_request_position/view" class="green"><i class="icon-share-alt"></i><span>Request Position </span></a></li>
      </ul>
    </div>
  </div>
</div>
<div class="row-fluid">
  <div class="span12">
    <div class="switch-board gray">
      <ul class="clearfix switch-item switch_item_custom">
        <li><a href="<?=base_url()?>index.php/rm_pif_friend/view" class="cls-color-1"><i class="icon-user"></i><span>PIF For Friend</span></a></li>
        <li><a href="<?=base_url()?>index.php/rm_martix_position/view" class="cls-color-6"><p>$<?=number_format($paymant['coin_balance'],2)?></p><span>Wallet</span></a></li>
        <li><a href="<?=base_url()?>index.php/rm_martix_withdrawal/view" class="bondi-blue"><i class="icon-money"></i><span>Withdrawal</span></a></li>
...
<div class="row-fluid">
  <div class="span12">
    <div class="switch-board gray">
      <ul class="clearfix switch-item switch_item_custom">
        <li><a href="<?=base_url()?>index.php/rm_matrix_notification/view" class="cls-color-8"><p><?=$notification?></p><span>New Notification</span></a></li>
      </ul>
    </div>
  </div>
</div>
