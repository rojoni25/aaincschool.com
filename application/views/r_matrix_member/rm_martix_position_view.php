...
<div class="row-fluid">
  ...
  <div class="span6">
    <h3 class="page-header">Wallet  <a href="<?=base_url()?>index.php/rm_martix/dashboard/" class="pull-right"><span class="label label-success"><font style="font-weight:bold;letter-spacing:1px;">Dashboard</font></span></a></h3>
    <table class="table table-striped table-bordered">
      <thead>
        <tr>
      ...
      <thead>
        <?php for($i=0;$i<count($multi_position);$i++){
					...
					echo '<tr class="tot_m_'.$multi_position[$i]['total'].'">
							...
							<th><a href="'.base_url().'index.php/rm_martix_position/position_detail/'.$multi_position[$i]['idcode'].'"><span class="label label-info">Member</span></a></th>
					</tr>';
				}?>
      </thead>
      <tfoot>
