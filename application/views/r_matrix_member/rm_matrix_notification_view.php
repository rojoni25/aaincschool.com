...
<h3 class="page-header">Notification <a href="<?=base_url()?>index.php/rm_martix/dashboard/" class="pull-right"><span class="label label-success"><font style="font-weight:bold;letter-spacing:1px;">Dashboard</font></span></a></h3>
<div class="row-fluid">
  <div class="span12">
