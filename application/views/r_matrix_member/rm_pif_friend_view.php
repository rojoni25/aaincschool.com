...
function search_member(){
		...
		var url='<?php echo base_url();?>index.php/rm_pif_friend/find_member/'+$('#meberserch').val();
...
<div class="row-fluid">
  <div class="span12">
    <h3 class="page-header">PIF For Friend 
    	...
    	<a href="<?=base_url()?>index.php/<?=$this->uri->segment(1)?>/extra_position_popup" class="pull-right show-pop-event"><span class="label label-success"><font style="font-weight:bold;letter-spacing:1px;font-size:16px;">PIF For Friend</font></span></a>
    </h3>
