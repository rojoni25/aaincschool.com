...
<div class="row-fluid">
  <div class="span6">
    ...
    <?php if($show_frm){ ?>
    		<form action="<?=MATRIX_BASE?><?=$this->uri->rsegment(1)?>/insert_request" method="POST" id="send_request">
      ...
      <table class="table table-striped table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>:</td>
            <td><textarea id="txtmsg" name="txtmsg" placeholder="Payment Option" class="span12 txt_area"></textarea></td>
          </tr>
  ...
  <div class="span6">
    <h3 class="page-header">Pending Request <a href="<?=MATRIX_BASE?>martix/dashboard/" class="pull-right"><span class="label label-success"><font style="font-weight:bold;letter-spacing:1px;">Dashboard</font></span></a></h3>
