...
<div class="row-fluid">
  <div class="span12">
    <h3 class="page-header">Position Details 
        <a href="<?=MATRIX_BASE?>martix/dashboard/" class="pull-right"><span class="label label-success"><font style="font-weight:bold;letter-spacing:1px;">Dashboard</font></span></a>
        <a style="margin-right:15px;" href="<?=MATRIX_BASE?>martix_position/view/" class="pull-right"><span class="label label-important"><font style="font-weight:bold;letter-spacing:1px;">Back</span></font></a>
        </h3>
