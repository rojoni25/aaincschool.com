  	...
  	<div class="tz-2-com tz-2-main">
		  ...
		  <div class="col-md-12">
		    <div class="switch-board gray">
		      <ul class="clearfix switch-item switch_item_custom">
		        <li><a href="<?=MATRIX_BASE?>martix_position/view/" class="orange">
		        	<i class="fa fa-file-text-o"></i><span>Position</span></a>
		        </li>
		        <li><a href="<?=MATRIX_BASE?>martix_position/view/" class=" blue-violate">
		        	<i class="fa fa-lightbulb-o"></i><span>Position Details</span></a>
		        </li>
		        <li><a href="<?=MATRIX_BASE?>martix_message/compose" class="dark-yellow"><i class="fa fa-share-square-o"></i><span>Message To Admin</span></a></li>
		        <li><a href="<?=MATRIX_BASE?>request_position/view" class="green"><i class="fa fa-share-square-o"></i><span>Request Position </span></a></li>
		...
		<div class="">
		  <div class="col-md-12">
		    <div class="switch-board gray"> 
		      <ul class="clearfix switch-item switch_item_custom">
		      	 <li><a href="<?=MATRIX_BASE?>pif_friend/view" class="cls-color-1"><i class="fa fa-user"></i><span>PIF For Friend</span></a></li>
		         ...
		         <li><a href="<?=MATRIX_BASE?>martix_withdrawal/view" class="bondi-blue"><i class="fa fa-money"></i><span>Withdrawal</span></a></li>
		         <li><a href="<?=base_url()?>index.php/capture_pages" class="cls-color-7"><i class="fa fa-th"></i><span>Capture Pages</span></a></li>
		      </ul>
		    </div>
		  </div>
		</div>
		  ...
		  <div class="col-md-12">
		    <div class="switch-board gray"> 
		      <ul class="clearfix switch-item switch_item_custom">
		         ...
		         <li><a href="<?=MATRIX_BASE?>company_pages/view/" class="cls-color-3"><i class="fa fa-book"></i><span>Company Pages</span></a></li>
		          <li><a href="<?=MATRIX_BASE?>contain/view/webinar" class="cls-color-1"><i class="fa fa-book"></i><span>Webinar</span></a></li>
		         <li><a href="<?=MATRIX_BASE?>contain/view/training" class="cls-color-5"><i class="fa fa-book"></i><span>Training</span></a></li>
		      </ul>
		    </div>
		  </div>
		</div>
