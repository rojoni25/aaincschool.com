...
<style type="text/css">
	...
	.show-payment-hide-20{
		display: none;
	}
	.board-widgets-botttom .a .unset {
		display: unset;
	}
	.size{
		font-size: 40px;
...
<div class="tz-2 tz-2-admin">
	<div class="tz-2-com tz-2-main">
		<h4 class="page-header">
			...
			<span class="pull-right">
		      	...
		      	<?php if ($status[0]['type'] =='Pending' || $status[0]['type'] !='Done') { ?>
		      	
		      	<!--<a class="payment_confirm" onclick="return confirm('You First Need to Pay your Affiliate ! \n If you pay Click > OK \n If you not pay Click > Cancel ')" href="<?=base_url()?>index.php/affiliate_confirm_payment/"><label class="label label-important">Affiliate Confirm Payment</label></a>&nbsp;&nbsp;&nbsp;-->
		    
		      <?php	} ?>
		      	<a class="payment_confirm" href="<?=base_url()?>index.php/payment_confirm/" style="cursor: pointer;"><label class="label label-success">Confirm Payment</label></a>&nbsp;&nbsp;&nbsp;
			...
			<div class="col-md-6">
			    ...
			    <?php
				   if($contain[0]['video_url']!=''){
						echo '<div class="video_frm span6">';
			    ...
			    <div class=" col-md-6 payment-form-container ">
    <div>
            ...
            <div class="front">
                ...
                <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g id="Front">
                        ...
                        <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">Expiry Date</text>
                        <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">card number</text>
                        <g>
                            <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire" class="st2 st5 st9">2019-12</text>
    ...
    <div class="form-container">
        ...
        <div class="field-container">
            <label for="expirationdate">Expiry Date (YYYY-MM)</label>
            <input id="expirationdate" name="expirydate" type="text" pattern="[0-9]*" inputmode="numeric">
        </div>
        <div class="field-container">
            <label for="securitycode">Security Code</label>
            <input id="securitycode" name="ccode"  type="text" pattern="[0-9]*" inputmode="numeric">
            <input id="amount" name="amount" value="23" type="hidden">
        </div>
        <div class="field-container">
            <h4 id="bill-to-title">Billing Address</h4>
        </div>
      
        <div class="field-container"></div>
        <div class="field-container">
            <label for="fname">First Name</label>
            <input id="fname" maxlength="20" type="text">
        </div>
        <div class="field-container">
            <label for="lname">Last Name</label>
            <input id="lname" maxlength="20" type="text">
        </div>
        <div class="field-container">
        ...
        <div class="field-container">
            ...
            <input id="zipcode" maxlength="6" type="text" pattern="[0-9]*" inputmode="numeric">
     </div>
        <div class="field-container">
        
            <img  id="payment-loading" class="hide-payment-form" style="height:30px;width:30px;margin-top:13%;margin-left:40%" src="<?=base_url();?>asset/img/authorize/loading.gif">
        </div>
        <div class="field-container">
            <p id="responseType"></p>
        </div>
        ...
        <div class="field-container">
        <button id="payment-confirm" class="">Pay($23)</button>
        </div>
...
<script type="text/javascript">
	function alert() {
    var txt;
    if (confirm("First Pay to your Affiliate !")) {
        txt = "You pressed OK!";
    } else {
