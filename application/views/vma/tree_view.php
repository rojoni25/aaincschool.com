...
<div class="row-fluid ">
 ...
 <div class="level3">
  ...
  <?php
            	$total_in_level1		=	$this->vma_class->count_member_on_level1();
				$total_in_level2		=	$this->vma_class->count_member_on_level2();
				$total_in_level3		=	$this->vma_class->count_member_on_level3();
				$total_in_level4		=	$this->vma_class->count_member_on_level4();
				
				
				
				
				$level_one_total		=	$total_in_level1 * 1.66;
				$level_two_total		=	$total_in_level2 * 1.66;
				$level_three_total		=	$total_in_level3 * 1.66;
				
				$level_member_sum		=	($total_in_level1 + $total_in_level2 + $total_in_level3);
				
				$service_member_sum		=	($total_in_level1 + $total_in_level2 + $total_in_level3 + $total_in_level4);
				
				$level_total_sum		=	($level_one_total + $level_two_total + $level_three_total);
				
				$active_in_level1		=	$this->vma_class->count_member_on_level1(true);
				$active_in_level2		=	$this->vma_class->count_member_on_level2(true);
				$active_in_level3		=	$this->vma_class->count_member_on_level3(true);
				
				$active_in_level4		=	$this->vma_class->count_member_on_level4(true);
				
				$active_member_sum		=	($active_in_level1 + $active_in_level2 + $active_in_level3);
				
				$service_active_sum		=	($active_in_level1 + $active_in_level2 + $active_in_level3 + $active_in_level4);
...
<div class="row-fluid">
   <div class="span6">
   		   <h3 class="page-header">Service Tree</h3>
  		<table class="table table-striped table-bordered">
        	
            <thead>
            	<tr>
            		<td width="20%">Level</td>
                	<td width="20%">Total Member</td>
                    <td width="30%">Active Member</td>
            ...
            <tr>
            	<td>Level-1</td>
                <td><?=$total_in_level1?></td>
                <td><?=$active_in_level1?></td>
               
            </tr>
            <tr>
            	<td>Level-2</td>
                <td><?=$total_in_level2?></td>
                <td><?=$active_in_level2?></td>
               
            </tr>
            <tr>
            	<td>Level-3</td>
                <td><?=$total_in_level3?></td>
                <td><?=$active_in_level3?></td>
          
            </tr>
            
             <tr>
            	<td>Level-4</td>
                <td><?=$total_in_level4?></td>
                <td><?=$active_in_level4?></td>
          
            </tr>
            
            <tr>
            	<td></td>
                 <td><?=$service_member_sum?></td>
                <td><?=$service_active_sum?></td>
  ...
  <div class="span6">
  		<table class="table table-striped table-bordered">
        	  <h3 class="page-header">Daily Income</h3>
            <thead>
            	<tr>
            		<td width="20%">Level</td>
                	<td width="20%">Total Member</td>
            ...
            <tbody>
            <tr>
            	<td>Level One Member</td>
                <td><?=$total_in_level1?></td>
                <td><?=$active_in_level1?></td>
                <td>$1.66</td>
                <td>$<?=number_format($level_one_total,2)?></td>
            </tr>
            <tr>
                ...
                <td><?=$active_in_level2?></td>
                <td>$1.66</td>
                <td>$<?=number_format($level_two_total,2)?></td>
            </tr>
            <tr>
                ...
                <td><?=$active_in_level3?></td>
                <td>$1.66</td>
                <td>$<?=number_format($level_three_total,2)?></td>
            </tr>
            
            <tr>
            	<td></td>
                 <td><?=$level_member_sum?></td>
                <td><?=$active_member_sum?></td>
                <td></td>
                <td>$<?=number_format($level_total_sum,2)?></td>
            </tr>
...
#contenttree li label.llb0{
	background: url(<?=base_url()?>asset/tree/icon-1.png) 15px 1px no-repeat;
}
#contenttree li label.llb1{
	background: url(<?=base_url()?>asset/tree/icon-2.png) 15px 1px no-repeat;
}
#contenttree li label.llb2{
	background: url(<?=base_url()?>asset/tree/icon-3.png) 15px 1px no-repeat;
}
#contenttree li label.llb3{
	background: url(<?=base_url()?>asset/tree/icon-4.png) 15px 1px no-repeat;
}
