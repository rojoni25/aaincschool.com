      ...
      <tbody>
        ...
        <tr>
          ...
          <th><?=date('d-m-Y',strtotime($result[$i]['timedt']))?></th>
           <th><a href="<?=vma_ad()?><?=$this->uri->rsegment(1)?>/delete1/<?=$result[$i]['id']?>"><span class="label label-important">Delete</span></a>
           	   &nbsp;&nbsp;&nbsp;<a href="<?=vma_ad()?>message/send/<?=$result[$i]['usercode']?>"><span class="label label-info">Send Email</span></a>
           </th>
        </tr>
        <?php } ?>
      </tbody>
