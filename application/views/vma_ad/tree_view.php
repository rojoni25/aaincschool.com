...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">VMA Tree
      	<div class="pull-right">
        	<a href="<?=vma_ad()?>member/detail/<?=$top_usercode?>"><button class="btn btn-round-min btn-danger"><span><i class="icon-eye-open"></i></span></button></a>
        </div>
      </h3>
    </div>
    ...
    <ul class="breadcrumb">
    	<?php
			$urltree=vma_ad().$this->uri->rsegment(1).'/view/';
