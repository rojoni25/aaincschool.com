		...
		<h4>
			...
			?>
				<span class="" style="color: #fff;padding-left: 10px;">
					...
					<span style="color: darkgoldenrod;font-size: 20px;">  Referal Wallet : </span>
		...
		<div class="">
			<div class="">
				<div class="tz-2-main-2 row"> 
					...
					?>
							<div class="col-md-3">
								<a href="<?=base_url();?>index.php/upgrade_membership/view/" class="btn btn-primary"><strong>$23 Enroll</strong></a>
							</div>
					...
					if($sub_status=="InActive"){ ?>
					 	<div class="col-md-3">
							<a href="<?=base_url();?>index.php/capture_pages/upgrade" class="btn btn-success"><strong>Add New Page</strong></a>
						</div>   
				<?	}else{
					?>
					<div class="col-md-3">
