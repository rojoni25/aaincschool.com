...
<div class="tz-2 tz-2-admin">
	<div class="tz-2-com tz-2-main">
		<h4>
			...
			<?php
				$upgraderesult	 =	$this->upgrade_membership_model->check_request_send();
			...
			<?		
				...
				if(isset($upgraderesult[0]['payment']) && $upgraderesult[0]['payment']=="Y"){
			?>
					<a href="#" class="btn btn-success btn-sm" style="padding: 5px;height: 30px;"><strong>Paid</strong></a>
			<?					
				}else{
			?>
					<a href="#" class="btn btn-danger btn-sm" style="padding: 5px;height: 30px;"><strong>Unpaid</strong></a>
			<?						
				}
			?>
			</span>
		...
		<div class="">
			<div class="">
				<div class="tz-2-main-2 row"> 
					<div class="col-md-3">
						<a href="<?=base_url();?>index.php/capture_pages?page_section=main_page" class="btn btn-warning"><strong>Free Capture Pages</strong></a>
					</div>
					<?php
			        ...
			        ?>
						...
						<div class="col-md-3">
							...
							<a href="<?=base_url();?>index.php/capture_pages/page_thum_list/Add" class="btn btn-success"><strong>capture page reseller</strong></a>
						</div>
					<?
					}else{
						if(!isset($upgraderesult[0])){
					?>
							<div class="col-md-3">
								<!--<a href="<?=base_url();?>index.php/upgrade_membership/view/" class="btn btn-primary"><strong>$20 Enroll</strong></a>-->
								<a href="<?=base_url();?>index.php/upgrade_membership/view/" class="btn btn-primary"><i class="fa fa-graduation-cap" aria-hidden="true"></i> <strong>Enroll $23 1-Time</strong></a>
							</div>
							<!---->
					<?	
						}
