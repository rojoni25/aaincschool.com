...
class coded_leg_tree_free extends CI_Controller {
	...
	function __construct()
 	{
		...
		$this->load->model('coded_leg_tree_free_model','',TRUE);
	...
	{
		$result=$this->coded_leg_tree_free_model->get_all_referral($this->session->userdata['logged_in_visa']['usercode']);
	...
	function get_next_level(){
		...
		$result=$this->coded_leg_tree_free_model->get_all_referral($usercode);
		$node_count=count($result);
