...
class five_by_three_free extends CI_Controller {
	...
	function get_tree($code=''){
		$result=$this->tree_view_free_model->get_node_five_by_three_by_id($code);
		$topnode=$this->tree_view_free_model->userdt_by_code($code);
		
		$tree_arr=array();
		$url=''.base_url().'index.php/five_by_three_free/tree/';
