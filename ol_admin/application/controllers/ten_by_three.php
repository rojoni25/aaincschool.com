...
class ten_by_three extends CI_Controller {
	...
	function get_tree($code=''){
		...
		if(isset($result[5])){
			...
			$tree_arr['node6_img']="<a class='show-pop-event' href='".$result[5]['usercode']."'><img src='".base_url()."/asset/images/multitree/red.png' title='".$name."' /></a>";
		...
		if(isset($result[6])){
			...
			$tree_arr['node7_img']="<a class='show-pop-event' href='".$result[6]['usercode']."'><img src='".base_url()."/asset/images/multitree/blue.png' title='".$name."' /></a>";
		...
		if(isset($result[7])){
			...
			$tree_arr['node8_img']="<a class='show-pop-event' href='".$result[7]['usercode']."'><img src='".base_url()."asset/images/multitree/green.png' title='".$name."' /></a>";
		...
		if(isset($result[8])){
			...
			$tree_arr['node9_img']="<a class='show-pop-event' href='".$result[8]['usercode']."'><img src='".base_url()."asset/images/multitree/red.png' title='".$name."' /></a>";
		...
		if(isset($result[9])){
			...
			$tree_arr['node10_img']="<a class='show-pop-event' href='".$result[9]['usercode']."'><img src='".base_url()."asset/images/multitree/blue.png' title='".$name."' /></a>";
	...
	function drow_breadcrumb_level($code){
		...
		while(1){
			...
			$user['bread'][]=$result;
			if($result[0]['uplingmember10_3']==$code){
