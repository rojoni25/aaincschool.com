...
class report extends CI_Controller {
	...
	function __construct()
 	{
		...
		$this->load->model('vma/report_model','ObjM',TRUE);
	...
	public function balance_sheet()
	{
		...
		$this->load->view(VMA_FOLDER.'member_balance_shit_list',$data);
	...
	function listing(){
		...
		for($i=0;$i<count($result);$i++)
		{
			$html.='<tr>
					...
					<td><a href="'.vma_base().''.$this->uri->rsegment(1).'/virtual_wallet/'.$result[$i]['usercode'].'">'.$result[$i]['virtual_in'].'</a></td>
					<td><a href="'.vma_base().''.$this->uri->rsegment(1).'/virtual_wallet/'.$result[$i]['usercode'].'">'.$result[$i]['virtual_out'].'</a></td>
					<td><a href="'.vma_base().''.$this->uri->rsegment(1).'/virtual_wallet/'.$result[$i]['usercode'].'">'.$result[$i]['virtual_balance'].'</a></td>
					<td><a href="'.vma_base().''.$this->uri->rsegment(1).'/main_wallet/'.$result[$i]['usercode'].'">'.$result[$i]['main_in'].'</a></td>
					<td><a href="'.vma_base().''.$this->uri->rsegment(1).'/main_wallet/'.$result[$i]['usercode'].'">'.$result[$i]['main_out'].'</a></td>
					<td><a href="'.vma_base().''.$this->uri->rsegment(1).'/main_wallet/'.$result[$i]['usercode'].'">'.$result[$i]['main_balance'].'</a></td>
	...
	function virtual_wallet($eid)
	{
		...
		$this->load->view('comman/topheader',$data);
		$this->load->view('comman/header');
		$this->load->view(VMA_FOLDER.'virtual_wallet_detail',$data);
		$this->load->view('comman/footer');
	}
	...
	function main_wallet($eid)
	{
		...
		$this->load->view('comman/topheader',$data);
		$this->load->view('comman/header');
		$this->load->view(VMA_FOLDER.'main_wallet_detail',$data);
		$this->load->view('comman/footer');
	}
	...
	function virtual_wallet_month_vise()
	{
		...
		$this->load->view('comman/topheader',$data);
		$this->load->view('comman/header');
		$this->load->view(VMA_FOLDER.'virtual_wallet_month_vise_list',$data);
		$this->load->view('comman/footer');
	}
	...
	function virtual_wallet_user_detail($eid)
	{
		...
		$this->load->view('comman/topheader',$data);
		$this->load->view('comman/header');
		$this->load->view(VMA_FOLDER.'virtual_wallet_payment_report',$data);
		$this->load->view('comman/footer');
	}
	...
	function unqulified()
	{
		...
		$this->load->view('comman/topheader',$data);
		$this->load->view('comman/header');
		$this->load->view(VMA_FOLDER.'unqulified_list',$data);
		$this->load->view('comman/footer');	
	}
