...
Class r_matrix_withdrawal_model extends CI_Model
{
 ...
 //   		$this -> db -> from(''.MATRIX_TABLE_PRE.'ember_withdrawal');
	// 	$query = $this -> db -> get();
 //    	$the_content = $query->result_array();
 //    	return $the_content;
	// }
		...
		function withdrawal_report()
		{
			...
			$this -> db -> select('tl_member_payment.usercode, tl_member_payment.email, tl_member_payment.currency, tl_member_payment.amount , tl_member_payment.card_exp_month,tl_member_payment.card_exp_year,tl_member_payment.name,tl_member_payment.address,tl_member_payment.country,tl_member_payment.status,tl_member_payment.id,tl_member_payment.timedt');

			$this -> db -> from('tl_member_payment');

			$this -> db -> join('membermaster','membermaster.usercode = tl_member_payment.usercode','left');
