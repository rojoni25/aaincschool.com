...
Class tree_view_model extends CI_Model
{
	...
	{
		$this -> db -> select('membermaster.fname,membermaster.lname');
		$this -> db -> select('member_node_reverse.*');
   		$this -> db -> from('member_node_reverse');
		$this -> db -> join('membermaster','membermaster.usercode = member_node_reverse.usercode','left');
	...
	{
		$this -> db -> select('membermaster.fname,membermaster.lname');
		$this -> db -> select('member_node_reverse.usercode,member_node_reverse.side_3_3');
   		$this -> db -> from('member_node_reverse');
		$this -> db -> join('membermaster','membermaster.usercode = member_node_reverse.usercode','left');
		$this -> db -> where('member_node_reverse.uplingmember3_3', ''.$eid.'');
		$this -> db -> order_by('member_node_reverse.side_3_3', 'asc');
    	$query = $this -> db -> get();
    	$the_content = $query->result_array();
    	return $the_content;
	}
	...
	{
		$this -> db -> select('membermaster.fname,membermaster.lname');
		$this -> db -> select('member_node_reverse.usercode,member_node_reverse.side_5_3');
   		$this -> db -> from('member_node_reverse');
		$this -> db -> join('membermaster','membermaster.usercode = member_node_reverse.usercode','left');
		$this -> db -> where('member_node_reverse.uplingmember5_3', ''.$eid.'');
		$this -> db -> order_by('member_node_reverse.side_5_3', 'asc');
    	$query = $this -> db -> get();
    	$the_content = $query->result_array();
    	return $the_content;
	}
	...
	{
		$this -> db -> select('membermaster.fname,membermaster.lname');
		$this -> db -> select('member_node_reverse.usercode,member_node_reverse.side_10_3');
   		$this -> db -> from('member_node_reverse');
		$this -> db -> join('membermaster','membermaster.usercode = member_node_reverse.usercode','left');
		$this -> db -> where('member_node_reverse.uplingmember10_3', ''.$eid.'');
		$this -> db -> order_by('member_node_reverse.side_10_3', 'asc');
    	$query = $this -> db -> get();
    	$the_content = $query->result_array();
    	return $the_content;
	}
