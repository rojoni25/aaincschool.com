...
Class upgrade_request_model extends CI_Model
{
	...
	{
		$this -> db -> select('membermaster.*');
		$this -> db -> select('paid_request_master.payment, paid_request_master.st_view, paid_request_master.payment_dt, paid_request_master.payment_dt, paid_request_master.timedt, paid_request_master.type, paid_request_master.txn_id, paid_request_master.confirm');
 ...
 //    	return $the_content;
	...
	function update($data,$table,$wherefield,$wherevalue){
 	...
 	function AffilatePayment()
 	{
  	...
  	function check_request_send($uid)
	{
		$this -> db -> select('*');
   		$this -> db -> from('paid_request_master');
