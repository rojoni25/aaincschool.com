<?php
    ...
    $arr_capture_page=array('capture_page_wallet','active_cp_member','inactive_cp_member');
	//--=====================for reverse wallet==================================---
	$reverse_wallet= array("reverse_five_by_three_wallet","reverse_ten_by_three_wallet","reverse_five_by_three_wallet_free","reverse_ten_by_three_wallet_free");


	if(in_array($this->uri->segment(1),$arr_master)){
	    if(in_array($this->uri->segment(2),$reverse_wallet)){
	        $reversewallet="active";
	        if($this->uri->segment(2)=="reverse_five_by_three_wallet"){
	            $sub_reverse_five_by_three_wallet="active";
	        }else  if($this->uri->segment(2)=="reverse_ten_by_three_wallet"){
	            $sub_reverse_ten_by_three_wallet="active";
	        }else  if($this->uri->segment(2)=="reverse_five_by_three_wallet_free"){
	            $sub_reverse_five_by_three_wallet_free="active";
	        }
	        else  if($this->uri->segment(2)=="reverse_ten_by_three_wallet_free"){
	            $sub_reverse_ten_by_three_wallet_free="active";
	        }
	       
	    }else if(in_array($this->uri->segment(2),$arr_capture_page)){
	        if($this->session->userdata['logged_in_visa']['user_type_id']=='3'){
	    $capture_page_main_link='active';
	    	// for capture page wallet
			if($this->uri->segment(2)=='capture_page_wallet'){
			$cp_wallet_smart='active';
		}
		// For capture pages subscribers Active 
		elseif($this->uri->segment(2)=='active_cp_member'){
			$active_cp_member_smart='active';
		}
		// For capture pages subscribers InActive 
		elseif($this->uri->segment(2)=='inactive_cp_member'){
			$inactive_cp_member_smart='active';
		}
	        }else{
	            $main_master='active';
	            // for capture page wallet
        		...
        		// For capture pages subscribers Active 
        		elseif($this->uri->segment(2)=='active_cp_member'){
        			$active_cp_member='active';
        		}
        		// For capture pages subscribers InActive 
        		elseif($this->uri->segment(2)=='inactive_cp_member'){
        			$inactive_cp_member='active';
        		}
	        }
		...
		// for capture page wallet
			elseif($this->uri->segment(2)=='capture_page_wallet'){
			$cp_wallet='active';
		}
		// For capture pages subscribers Active 
		elseif($this->uri->segment(2)=='active_cp_member'){
		...
		}elseif($this->uri->segment(2)=='paid_bonus_wallet'){
			$paidwallet_bonus='active';
		}
		elseif($this->uri->segment(2)=='paid_aainc_wallet'){
			$aaincwallet_member='active';
		}elseif($this->uri->segment(2)=='aainc_wallet'){
			$freeaaincwallet_member='active';
		}
  ...
  <div class="left-nav clearfix">
    <div class="left-primary-nav">
      <ul id="myTab">
        <?php if($this->session->userdata['logged_in_visa']['user_type_id']=='1') {?>
	        ...
	        <li class="<?=$reversewallet?>"><a href="#reversewallet" class="icon-group" title="Reverse Matrix"></a></li> <!--For Reverse Matrix hidden walletsAdded by softexprt -->
        ...
        <?php if($this->session->userdata['logged_in_visa']['user_type_id']=='3'){?>
	        <li class="<?=$main_master?>"><a href="#master" class="icon-th-large" title="Master"></a></li>
	         <li class="<?=$capture_page_main_link?>"><a href="#capture_page_smart" class="icon-asterisk" title="Capture Pages"></a></li>
    ...
    <div class="left-secondary-nav tab-content">
      	...
      	if($this->session->userdata['logged_in_visa']['user_type_id']=='1') {?>
			...
			<div class="tab-pane <?=$main_master?>" id="master">
				...
				<ul id="nav" class="accordion-nav">
				  ...
				  <li class="<?=$wallet_member?>"><a href="<?php echo base_url();?>index.php/user/paid_leader_wallet"><i class="icon-th"></i>Paid Member Wallet</a></li>
				  <li class="<?=$paidwallet_bonus?>"><a href="<?php echo base_url();?>index.php/user/paid_bonus_wallet"><i class="icon-th"></i> Paid Bonus Wallet</a></li>
				  <li class="<?=$aaincwallet_member?>"><a href="<?php echo base_url();?>index.php/user/paid_aainc_wallet"><i class="icon-th"></i> Paid AAINC Wallet</a></li>
				  <li class="<?=$cp_wallet?>"><a href="<?php echo base_url();?>index.php/user/capture_page_wallet"><i class="icon-th"></i> Capture Page Wallet </a></li><!--For capture page wallet-->
				  <li class="<?=$active_cp_member?>"><a href="<?php echo base_url();?>index.php/user/active_cp_member"><i class="icon-th"></i> Active C.P Member </a></li><!--For Active capture page subscribers-->
				  <li class="<?=$inactive_cp_member?>"><a href="<?php echo base_url();?>index.php/user/inactive_cp_member"><i class="icon-th"></i> InActive C.P Member </a></li><!--For InActive capture page subscribers-->
				  ...
				  <li class="<?=$freeaaincwallet_member?>"><a href="<?php echo base_url();?>index.php/user/aainc_wallet"><i class="icon-th"></i> Free AAINC Wallet</a></li>
			...
			<!--==============================================================Reverse Wallet Menu===============================================================-->
            <div class="tab-pane <?=$reversewallet?>" id="reversewallet">
        				<h4 class="side-head">Paid Reverse Wallet</h4>
        				<ul class="accordion-nav">
        				  <li class="<?=$sub_reverse_two_by_three_wallet?>"><a href="<?php echo base_url();?>index.php/user/reverse_two_by_three_wallet"><i class="icon-table"></i> Reverse 2 x 3 Wallet </a></li>
        				  <li class="<?=$sub_reverse_three_by_three_wallet?>"><a href="<?php echo base_url();?>index.php/user/reverse_three_by_three_wallet"><i class="icon-table"></i> Reverse 3 x 2 Wallet </a></li>
        				  <li class="<?=$sub_reverse_five_by_three_wallet?>"><a href="<?php echo base_url();?>index.php/user/reverse_five_by_three_wallet"><i class="icon-table"></i> Reverse 5 x 3 Wallet </a></li>
        				  <li class="<?=$sub_reverse_ten_by_three_wallet?>"><a href="<?php echo base_url();?>index.php/user/reverse_ten_by_three_wallet"><i class="icon-table"></i> Reverse 10 x 3 Wallet </a></li>
        				  <li class="<?=$sub_reverse_twelve_by_three_wallet?>"><a href="<?php echo base_url();?>index.php/user/reverse_twelve_by_three_wallet"><i class="icon-table"></i> Reverse 12 x 3 Wallet </a></li>
        				  <li class="<?=$sub_reverse_fifteen_by_three_wallet?>"><a href="<?php echo base_url();?>index.php/user/reverse_fifteen_by_three_wallet"><i class="icon-">&#xf022;</i>Reverse 15 x 3 Wallet </a></li>
        				  <li class="<?=$sub_reverse_twenty_by_three_wallet?>"><a href="<?php echo base_url();?>index.php/user/reverse_twenty_by_three_wallet"><i class="icon-table"></i> Reverse 20 x 3 wallet </a></li>
        				</ul>
        				<h4 class="side-head">Free Reverse Wallet</h4>
        				<ul class="accordion-nav">
        				  <li class="<?=$sub_reverse_two_by_three_wallet_free?>"><a href="<?php echo base_url();?>index.php/user/reverse_two_by_three_wallet_free"><i class="icon-table"></i> Reverse 2 x 3 Wallet Free</a></li>
        				  <li class="<?=$sub_reverse_three_by_three_wallet_free?>"><a href="<?php echo base_url();?>index.php/user/reverse_three_by_three_wallet_free"><i class="icon-table"></i> Reverse 3 x 2 Wallet Free</a></li>
        				  <li class="<?=$sub_reverse_five_by_three_wallet_free?>"><a href="<?php echo base_url();?>index.php/user/reverse_five_by_three_wallet_free"><i class="icon-table"></i> Reverse 5 x 3 Wallet Free</a></li>
        				  <li class="<?=$sub_reverse_ten_by_three_wallet_free?>"><a href="<?php echo base_url();?>index.php/user/reverse_ten_by_three_wallet_free"><i class="icon-table"></i> Reverse 10 x 3 Wallet Free</a></li>
        				  <li class="<?=$sub_reverse_twelve_by_three_wallet_free?>"><a href="<?php echo base_url();?>index.php/user/reverse_twelve_by_three_wallet_free"><i class="icon-table"></i> Reverse 12 x 3 Wallet Free</a></li>
        				  <li class="<?=$sub_reverse_fifteen_by_three_wallet_free?>"><a href="<?php echo base_url();?>index.php/user/reverse_fifteen_by_three_wallet_free"><i class="icon-">&#xf022;</i>Reverse 15 x 3 Wallet Free</a></li>
        				  <li class="<?=$sub_reverse_twenty_by_three_wallet_free?>"><a href="<?php echo base_url();?>index.php/user/reverse_twenty_by_three_wallet_free"><i class="icon-table"></i> Reverse 20 x 3 wallet Free</a></li>
        				</ul>
        	</div>
      	...
      	if($this->session->userdata['logged_in_visa']['user_type_id']=='3') {?>
			...
			<div class="tab-pane <?=$capture_page_main_link?>" id="capture_page_smart">
				<ul class="accordion-nav">
				<li class="<?=$cp_wallet_smart?>"><a href="<?php echo base_url();?>index.php/user/capture_page_wallet"><i class="icon-th"></i> Capture Page Wallet </a></li><!--For capture page wallet-->
				<li class="<?=$active_cp_member_smart?>"><a href="<?php echo base_url();?>index.php/user/active_cp_member"><i class="icon-th"></i> Active C.P Member </a></li>
				  <li class="<?=$inactive_cp_member_smart?>"><a href="<?php echo base_url();?>index.php/user/inactive_cp_member"><i class="icon-th"></i> InActive C.P Member </a></li>
				</ul>
			</div>
			<div class="tab-pane <?=$main_report?>" id="report">
				...
				<ul class="accordion-nav">
				  ...
				  <li class="<?=$sub_withdrawal_monthly_report?>"><a href="<?php echo base_url();?>index.php/user/paid_aainc_wallet"><i class="icon-file-alt"></i>Paid AAINC Wallets</a></li>
			...
			<div class="tab-pane <?=$main_report?>" id="report">
				...
				<ul class="accordion-nav">
				 ...
				 <!--  <li class="<?=$sub_daily_payment_by_member?>"><a href="<?php echo base_url();?>index.php/daily_payment_by_member/view"><i class="icon-file-alt"></i>Daily Payment(Member)</a></li>
				  ...
				  <li class="<?=$sub_withdrawal_monthly_report?>"><a href="<?php echo base_url();?>index.php/user/paid_leader_wallet"><i class="icon-file-alt"></i>Paid W1 Wallets</a></li>
				  <li class="<?=$sub_withdrawal_monthly_report?>"><a href="<?php echo base_url();?>index.php/user/paid_aainc_wallet"><i class="icon-file-alt"></i>Paid AAINC Wallets</a></li>
				  <li class="<?=$active_cp_member?>"><a href="<?php echo base_url();?>index.php/user/active_cp_member"><i class="icon-th"></i> Active C.P Member </a></li>
				  <li class="<?=$inactive_cp_member?>"><a href="<?php echo base_url();?>index.php/user/inactive_cp_member"><i class="icon-th"></i> InActive C.P Member </a></li>
				  ...
				  <li class="<?=$remaintosmarttransfer?>"><a href="<?php echo base_url();?>index.php/reports/remaintosmart_transfer_report"><i class="icon-file-alt"></i>WalletR to Smartw Transfer Report</a></li>
