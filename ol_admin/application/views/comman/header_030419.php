<?php
	...
	$arr_matrix		=	array('three_by_three','five_by_three','ten_by_three','unilevel','coded_leg_tree', 'three_by_three_free','five_by_three_free','ten_by_three_free','unilevel_free','coded_leg_tree_free');
  ...
  <div class="left-nav clearfix">
    <div class="left-primary-nav">
      <ul id="myTab">
        ...
        <?php } ?>
        <?php if($this->session->userdata['logged_in_visa']['user_type_id']=='2' || $this->session->userdata['logged_in_visa']['user_type_id']=='1') {?>
