...
<script>
	$(document).ready(function(e) {
		...
		$(document).on('click', '.remove_row', function (e) {
			...
			var url_update='<?=base_url()?>index.php/media_upload/update_record/'+value;
...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">Media List <?=$label?>
        <div class="pull-right">
          <a href="<?=base_url()?>index.php/media_upload?type=image"><button class="btn btn-success" type="button"><strong>Images</strong></button></a>
          <a href="<?=base_url()?>index.php/media_upload?type=youtube"><button class="btn btn-warning" type="button"><strong>Youtube</strong></button></a>
          <a href="<?=base_url()?>index.php/media_upload?type=ppt"><button class="btn btn-primary" type="button"><strong>PPT</strong></button></a>
          <a href="<?=base_url()?>index.php/media_upload?type=mp4"><button class="btn btn-danger" type="button"><strong>MP4</strong></button></a>
          <a href="<?=base_url()?>index.php/media_upload?type=audio"><button class="btn btn-info" type="button"><strong>Audio</strong></button></a>
        </div>
      </h3>
    </div>
    <div style="margin-bottom:10px;">
    <a href="<?=base_url()?>index.php/media_upload/addnew/Add/?type=<?=$mediatype?>"><button class="<?=$cls?>" type="button"><strong><?=$btltext?></strong></button></a>
    </div>
    <ul class="breadcrumb">
      <li><a href="#" class="icon-home"></a><span class="divider "><i class="icon-angle-right"></i></span></li>
      <li><a href="#">Upload Media</a><span class="divider"><i class="icon-angle-right"></i></span></li>
