		...
		<div class="span6">
        	<div class="content-widgets white">
                ...
                <div class="widget-container">
                    <form class="form-horizontal left-align" id="form2" method="post" action="<?php echo base_url();?>index.php/payment_report/paid_payment_daily" enctype="multipart/form-data">
