...
<div class="row-fluid">
  ...
  <div class="span6">
    <div class="page-header">RM Wallet</div>
    <table class="table">
      <tbody>
        <tr>
          <th>RM Wallet</th>
      ...
      <thead>
        <?php for($i=0;$i<count($multi_position);$i++){
					...
					echo '<tr class="tot_m_'.$multi_position[$i]['total'].'">
							...
							<th><a href="'.base_url().'index.php/r_matrix_tree/view/'.$multi_position[$i]['idcode'].'"><span class="label label-info">Tree View</span></a></th>
					</tr>';
				}?>
      </thead>
      <tfoot>
...
<div class="row-fluid">
  ...
  <div class="span6">
    <div class="page-header">RM Wallet Withdrawal</div>
    <table class="table table-striped table-bordered">
      <thead>
      		<tr>
          		<th>Id</th>
