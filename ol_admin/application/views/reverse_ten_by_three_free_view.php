...
<script>
	$(document).ready(function(e) {
		...
		var url2='<?php echo base_url()?>index.php/comman_controler_free/get_level_summary/<?php echo $this->uri->segment(3)?>/?tree=10';
		...
		$(document).on('click', '.btngoto', function (e) {
		  ...
		  $(document).on('click', '.clsmemdt', function (e) {
				...
				var url='<?php echo base_url()?>index.php/comman_controler_free/get_memberdt_by_id/'+value+'/10';
	...
	$(document).ready(function(e) {
		$('.show-pop-event').each(function(i,elem) {
						...
						$(this).webuiPopover({
							...
							type:'async',
							container: "body",
							url:'<?php echo base_url()?>index.php/comman_controler_free/get_memberdt_by_id/'+value+'/10',
							cache:false,
