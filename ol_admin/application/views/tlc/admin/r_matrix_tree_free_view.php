	...
	$(document).ready(function(e) {
		...
		$(document).on('click', '.btngoto', function (e) {
			...
			if(value==''){
				...
				window.location.href='<?php echo MATRIX_BASE?><?php echo $this->uri->rsegment(1)?>/view/'+value;
			}
		});
	   ...
	   $("#membername").autocomplete({
                        source:'<?php echo MATRIX_BASE;?><?php echo $this->uri->rsegment(1)?>/auto_camplate',
...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">Tree 2 x 3 Free </h3>
    </div>
    <div class="pull-left">
    ...
    <div class="pull-right">
      ...
      <select id="multi_position">
        <?php for($i=0;$i<count($position);$i++){
		   		$pos=$i+1;
				$sel=($position[$i]['idcode']==$this->uri->segment(4)) ? "selected='selected'" : "";
    ...
    <ul class="breadcrumb">
      <?php
			$urltree=MATRIX_BASE.$this->uri->rsegment(1).'/tree/';
...
<div class="treediv">
  <div class="treeinner">
    <?
    if($top[0]['angel_position']>0){
          $angel_mem = $this->ObjM->search_member_from_angel($top[0]['angel_position']);
          $posArr = $this->ObjM->get_current_position($top[0]['idcode'],$top[0]['usercode']);
          $posno = $posArr['cntno'];
          $topname = 'Angel vs '.$angel_mem['fname'].' '.$posno;      
    ?> 
      <div class="top" style="text-align:center;"> <img src="<?=base_url();?>asset/images/multitree/orange.png" />
    ...
    <?
          ...
          $posArr = $this->ObjM->get_current_position($top[0]['idcode'],$top[0]['usercode']);
          $posno = $posArr['cntno']>1?$posArr['cntno']:'';
          $topname = $top[0]['name'].' '.$posno;      
    ?>
    ...
    <div class="level4">
      <ul class="child4">
        <img class="linehr2" src="<?=base_url();?>asset/images/multitree/44.png" />
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[14]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[14]['idcode']?>'>
            <?=$tree_elements[14]['name']?>
            </a></p>
        </li>
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[15]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[15]['idcode']?>'>
            <?=$tree_elements[15]['name']?>
            </a></p>
        </li>
        <div class="clear"></div>
      </ul>
      <ul class="child4">
        <img class="linehr2" src="<?=base_url();?>asset/images/multitree/44.png" />
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[16]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[16]['idcode']?>'>
            <?=$tree_elements[16]['name']?>
            </a></p>
        </li>
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[17]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[17]['idcode']?>'>
            <?=$tree_elements[17]['name']?>
            </a></p>
        </li>
        <div class="clear"></div>
      </ul>
      <ul class="child4">
        <img class="linehr2" src="<?=base_url();?>asset/images/multitree/44.png" />
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[18]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[18]['idcode']?>'>
            <?=$tree_elements[18]['name']?>
            </a></p>
        </li>
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[19]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[19]['idcode']?>'>
            <?=$tree_elements[19]['name']?>
            </a></p>
        </li>
        <div class="clear"></div>
      </ul>
      <ul class="child4">
        <img class="linehr2" src="<?=base_url();?>asset/images/multitree/44.png" />
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[20]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[20]['idcode']?>'>
            <?=$tree_elements[20]['name']?>
            </a></p>
        </li>
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[21]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[21]['idcode']?>'>
            <?=$tree_elements[21]['name']?>
            </a></p>
        </li>
        <div class="clear"></div>
      </ul>
      <ul class="child4">
        <img class="linehr2" src="<?=base_url();?>asset/images/multitree/44.png" />
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[22]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[22]['idcode']?>'>
            <?=$tree_elements[22]['name']?>
            </a></p>
        </li>
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[23]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[23]['idcode']?>'>
            <?=$tree_elements[23]['name']?>
            </a></p>
        </li>
        <div class="clear"></div>
      </ul>
      <ul class="child4">
        <img class="linehr2" src="<?=base_url();?>asset/images/multitree/44.png" />
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[24]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[24]['idcode']?>'>
            <?=$tree_elements[24]['name']?>
            </a></p>
        </li>
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[25]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[25]['idcode']?>'>
            <?=$tree_elements[25]['name']?>
            </a></p>
        </li>
        <div class="clear"></div>
      </ul>
      <ul class="child4">
        <img class="linehr2" src="<?=base_url();?>asset/images/multitree/44.png" />
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[26]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[26]['idcode']?>'>
            <?=$tree_elements[26]['name']?>
            </a></p>
        </li>
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[27]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[27]['idcode']?>'>
            <?=$tree_elements[27]['name']?>
            </a></p>
        </li>
        <div class="clear"></div>
      </ul>
      <ul class="child4">
        <img class="linehr2" src="<?=base_url();?>asset/images/multitree/44.png" />
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[28]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[28]['idcode']?>'>
            <?=$tree_elements[28]['name']?>
            </a></p>
        </li>
        <li><img class="line" src="<?=base_url();?>asset/images/multitree/vr_line.jpg" />
          <?=$tree_elements[29]['img']?>
          <p><a class='show-pop-event' href='<?=$tree_elements[29]['idcode']?>'>
            <?=$tree_elements[29]['name']?>
            </a></p>
        </li>
        <div class="clear"></div>
      </ul>
	...
	$(document).ready(function(e) {
		...
		$('.show-pop-event').each(function(i,elem) {
						...
						$(this).webuiPopover({
							...
							type:'async',
							container: "body",
							url:'<?php echo MATRIX_BASE?><?php echo $this->uri->rsegment(1)?>/get_memberdt_by_id/'+value+'',
							cache:false,
