<script>
	...
	$('#data-table').dataTable( {
		...
		"bServerSide": true,
		"bSort": true,
		"sAjaxSource": "<?=base_url()?>index.php/user/listing_active",
		"aLengthMenu": [[100, 200, 500, 1000], [100, 200, 500, 1000]],
		"iDisplayLength":100,
		"fnRowCallback": function (row, data, displayNum, displayIndex, dataIndex) {
		    if(data[12]==0){
		        $("td:eq(0) span",row).css("color","rgba(255, 0, 0, 1) !important");
		        $("td:eq(1)",row).css("color","rgba(255, 0, 0, 1)");
...
<div class="row-fluid ">
  <div class="span12">
    <div class="primary-head">
      <h3 class="page-header">User Master
      <a href="<?php echo base_url();?>index.php/export_excel/member/?r=Active" style="float:right;" title="Export To Excel"><img src="<?php echo base_url();?>asset/images/excel-icon.png" width="30" /></a>
      </h3>
    </div>
    <ul class="breadcrumb">
