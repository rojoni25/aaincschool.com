        ...
        <div class="primary-head">
          <h3 class="page-header">Virtual Wallet Income 
          		<div class="pull-right">
            		<a href="<?=vma_base()?>report/balance_sheet"><button class="btn btn-round-min btn-success" type="button"><span><i class="icon-th-list"></i></span></button></a>
                    <a href="<?=vma_base()?>member/detail/<?=$result['usercode']?>"><button class="btn btn-round-min btn-warning" type="button"><span><i class=" icon-user"></i></span></button></a>
                </div>
      ...
      <div class="span6">
      		<table class="table table-striped table-bordered">
            	<tr>
                    ...
                    <td width="1%">:</td>
                    <td width="80%"><a href="<?=vma_base()?>report/virtual_wallet/<?=$result['usercode']?>">$<?=number_format($payment['in'],2)?></a></td>
                </tr>
                <tr>
                	<td>Total Payment</td>
                    <td>:</td>
                    <td><a href="<?=vma_base()?>report/virtual_wallet_user_detail/<?=$result['usercode']?>">$<?=number_format($payment['out'],2)?></a></td>
                </tr>
                <tr>
                	<td>Total Balance</td>
                    <td>:</td>
                ...
                <tr>
                	<td colspan="3">
                    	<a href="<?=vma_base()?>member/detail/<?=$result['usercode']?>"><span class="label label-success">Member Profile</span></a> &nbsp;&nbsp;
