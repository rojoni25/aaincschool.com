...
class CI_Email {
	...
	var	$mailpath		= "/usr/sbin/postfix";	// Sendmail path
	var	$protocol		= "smtp";	// mail/sendmail/smtp
	
//	var	$smtp_host		= "mail.opportunitylaunch.biz";		// SMTP Server.  Example: mail.earthlink.net
//	var	$smtp_user		= "opp_launch@opportunitylaunch.biz";		// SMTP Username
//	var	$smtp_pass		= "snupsnap@123";		// SMTP Password

	//active
	var	$smtp_host		= "smtp.sendgrid.net";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "opplaunch";	// SMTP Username
	var	$smtp_pass		= "1password";		// SMTP Password
	var	$smtp_port		= "587";	// SMTP Port
		
//	var	$smtp_host		= "smtp.sendgrid.net";		// SMTP Server.  Example: mail.earthlink.net
//	var	$smtp_user		= "hardikphoenix";	// SMTP Username
//	var	$smtp_pass		= "14mcal106";		// SMTP Password
//	var	$smtp_port		= "587";	// SMTP Port


//Send Mail Through postmark

//	var	$smtp_host		= "smtp.postmarkapp.com";		// SMTP Server.  Example: mail.earthlink.net
//	var	$smtp_user		= "4f211ce0-0c5f-46f2-8671-f9c3dc9599f2";	// SMTP Username
//	var	$smtp_pass		= "4f211ce0-0c5f-46f2-8671-f9c3dc9599f2";		// SMTP Password
//	var	$smtp_port		= "587";	// SMTP Port
